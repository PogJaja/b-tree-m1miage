...
public class BTreePlus<Type> implements java.io.Serializable {
    ...
    private ArrayList<Type> values = new ArrayList<>();
    private Research writer = new Research();
    ...
    public boolean addValeur(Type valeur, int ligne) {
        System.out.println("Ajout de la valeur : " + valeur.toString() + ", depuis la ligne " + ligne);
        if (racine.contient(valeur) == null) {
    ...
    public ArrayList<Type> listCreate() {
        ArrayList<Type> CopieListeValeur = new ArrayList<>(this.values);
    ...
    public Integer rechercheSequentielleArbre(Integer value) {
    ...
    public Integer rechercheSequentielleFichier(Integer value) {
    ...
    public static <T> T executeWithTimeMeasurement(Supplier<T> task) {
    ...
    public void research() {
        if (this.values.size() == 0) {
            ...
            ArrayList<Type> liste = this.listCreate();
            Date date = new Date();
            ...
            for (Type element : liste) {
                ...
                begin = System.nanoTime();
                this.rechercheSequentielleArbre((Integer) element);
                end = System.nanoTime();
                ...
                begin = System.nanoTime();
                this.rechercheSequentielleFichier((Integer) element);
                end = System.nanoTime();
